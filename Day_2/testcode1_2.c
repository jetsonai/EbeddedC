...
void ShiftOpTest(void)
{
    ...
    printf("stestnum : %d  ->", stestnum );
    printbin(stestnum);   
   printf("stestnum / 2  : %d  ->", sresrval1 );
   printbin(sresrval1);    
   printf("stestnum >> 1  : %d  ->", sresrval2 );
   printbin(sresrval2);     
   printf("stestnum * 2  : %d  ->", sreslval1 );
   printbin(sreslval1);    
   printf("stestnum >> 1  : %d  ->", sreslval2 );
   printbin(sreslval1);  
   printf("---\n");
   printf("utestnum : %d  ->", utestnum );
   printbin(utestnum); 
   printf("utestnum / 2  : %d  ->", uresrval1 );
   printbin(uresrval1);    
   printf("utestnum >> 1  : %d  ->", uresrval2 );
   printbin(uresrval2);     
   printf("utestnum * 2  : %d   ->", ureslval1 );
   printbin(ureslval1);    
   printf("utestnum >> 1  : %d  ->", ureslval2 );
   printbin(ureslval1);   
   printf("---\n");   
}
